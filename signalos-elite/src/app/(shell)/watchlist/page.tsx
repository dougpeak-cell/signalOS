...
function getDailyDollarChange(price: number | null | undefined, changePct: number | null | undefined) {
  if (!hasUsablePrice(price) || typeof changePct !== "number" || !Number.isFinite(changePct)) {
    return null;
  }
              ...
              <div className="flex flex-wrap items-center gap-3">
                {canUseDetail ? (
                  <Link
                    ...
                    className={`inline-flex h-10 items-center justify-center rounded-xl border px-4 text-sm font-medium transition ${detailButtonClass}`}
                  >
                    Detail View
                  </Link>
                ) : (
