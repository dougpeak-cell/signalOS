...
const baseEntries: Entry[] = [
  ...
  {
    term: "Analyst Rating",
    category: "Experts Terms",
    definition: "A research firm’s opinion of how a stock may perform. Rating scales vary by firm and are not guarantees.",
    example: "Buy, Hold, Outperform, and Sector Weight are analyst ratings.",
    signalosUse: "Experts shows the published rating beside the firm and date so you can judge the call in context.",
  },
  {
    term: "Analyst Action",
    category: "Experts Terms",
    definition: "A new published decision about a stock rating, such as an upgrade, downgrade, or reiteration.",
    example: "A firm changes a stock from Hold to Buy, creating an upgrade action.",
    signalosUse: "Experts orders actions newest first in each stock’s pick history.",
  },
  {
    term: "Previous Rating",
    category: "Experts Terms",
    definition: "The rating a firm assigned before its latest published action.",
    example: "Previous: Hold, Rating: Buy means the firm raised its view from Hold to Buy.",
    signalosUse: "Compare Previous with Rating to see whether the analyst’s view changed.",
  },
  {
    term: "Reiterated",
    category: "Experts Terms",
    definition: "The firm published an update but kept its existing rating unchanged.",
    example: "Previous: Buy and Rating: Buy is shown as Reiterated.",
    signalosUse: "A reiteration confirms the stated rating, but it does not necessarily mean the price target stayed the same.",
  },
  {
    term: "Upgrade",
    category: "Experts Terms",
    definition: "A firm changed its rating to a more favorable level.",
    example: "Moving from Hold to Buy is an upgrade.",
    signalosUse: "Experts highlights upgrades as positive changes in analyst opinion.",
  },
  {
    term: "Downgrade",
    category: "Experts Terms",
    definition: "A firm changed its rating to a less favorable level.",
    example: "Moving from Buy to Hold is a downgrade.",
    signalosUse: "Experts highlights downgrades as negative changes in analyst opinion.",
  },
  {
    term: "Strong Buy",
    category: "Experts Terms",
    definition: "A firm’s highest or near-highest positive rating, indicating strong expected performance under its rating system.",
    example: "Strong Buy generally expresses more conviction than Buy at the same firm.",
    signalosUse: "SigiOS gives positive ratings more weight, while still considering recency, target, and risk.",
  },
  {
    term: "Buy",
    category: "Experts Terms",
    definition: "A positive rating indicating that a firm expects the stock to perform favorably over its stated time horizon.",
    example: "A Buy rating may mean the analyst expects meaningful upside from the current price.",
    signalosUse: "Experts treats Buy as bullish analyst evidence, not as an automatic instruction to purchase shares.",
  },
  {
    term: "Hold",
    category: "Experts Terms",
    definition: "A neutral rating indicating that a firm does not currently see enough expected upside or downside for a stronger call.",
    example: "Hold may suggest keeping an existing position while waiting for clearer evidence.",
    signalosUse: "Experts treats Hold as neutral context rather than a bullish or bearish signal by itself.",
  },
  {
    term: "Sell",
    category: "Experts Terms",
    definition: "A negative rating indicating that a firm expects weak performance or meaningful downside risk.",
    example: "A downgrade from Hold to Sell signals a more bearish analyst view.",
    signalosUse: "Experts treats Sell as bearish evidence and displays it alongside the action date and firm.",
  },
  {
    term: "Outperform",
    category: "Experts Terms",
    definition: "A firm expects the stock to perform better than a benchmark, market, or peer group over its rating period.",
    example: "Outperform can mean the stock is expected to beat its sector even if the whole sector declines.",
    signalosUse: "Experts generally interprets Outperform as a positive rating.",
  },
  {
    term: "Underperform",
    category: "Experts Terms",
    definition: "A firm expects the stock to perform worse than a benchmark, market, or peer group over its rating period.",
    example: "Underperform can mean lagging the sector, even when the stock’s price still rises.",
    signalosUse: "Experts generally interprets Underperform as a negative rating.",
  },
  {
    term: "Overweight",
    category: "Experts Terms",
    definition: "A positive relative rating suggesting investors hold more of the stock than its weight in a benchmark or model portfolio.",
    example: "Overweight often carries a meaning similar to Buy or Outperform.",
    signalosUse: "Experts generally treats Overweight as bullish analyst evidence.",
  },
  {
    term: "Underweight",
    category: "Experts Terms",
    definition: "A negative relative rating suggesting investors hold less of the stock than its weight in a benchmark or model portfolio.",
    example: "Underweight often carries a meaning similar to Sell or Underperform.",
    signalosUse: "Experts generally treats Underweight as bearish analyst evidence.",
  },
  {
    term: "Equal Weight",
    category: "Experts Terms",
    definition: "A neutral relative rating suggesting a position close to the stock’s weight in the relevant benchmark.",
    example: "Equal Weight often carries a meaning similar to Hold or Market Perform.",
    signalosUse: "Experts generally treats Equal Weight as a neutral rating.",
  },
  {
    term: "Sector Weight",
    category: "Experts Terms",
    definition: "A neutral relative rating indicating expected performance roughly in line with the stock’s sector.",
    example: "Sector Weight means the analyst does not expect clear outperformance or underperformance versus sector peers.",
    signalosUse: "Experts generally treats Sector Weight as neutral context.",
  },
  {
    term: "Sector Perform",
    category: "Experts Terms",
    definition: "A neutral rating indicating that a stock is expected to perform approximately in line with its sector.",
    example: "Sector Perform is commonly comparable to Hold or Equal Weight.",
    signalosUse: "Experts generally treats Sector Perform as a neutral rating.",
  },
  {
    term: "Market Perform",
    category: "Experts Terms",
    definition: "A neutral rating indicating that a stock is expected to perform approximately in line with the broader market.",
    example: "Market Perform does not necessarily predict a flat stock; it compares the stock with the market.",
    signalosUse: "Experts generally treats Market Perform as a neutral rating.",
  },
  {
    term: "Price Target",
    category: "Experts Terms",
    definition: "An analyst’s estimate of where a stock could trade within a stated period, often about 12 months.",
    example: "A $150 target on a $120 stock implies $30 of estimated upside.",
    signalosUse: "Experts compares the consensus target with the current price to calculate potential upside or downside.",
  },
  {
    term: "Consensus Target",
    category: "Experts Terms",
    definition: "A combined or average price target derived from estimates published by multiple analysts.",
    example: "Targets of $140, $150, and $160 produce a consensus near $150.",
    signalosUse: "Experts uses the consensus target to reduce reliance on a single firm’s estimate.",
  },
  {
    term: "Analyst Upside",
    category: "Experts Terms",
    definition: "The percentage difference between the current stock price and an analyst or consensus price target.",
    example: "A $120 stock with a $150 target has 25% implied upside.",
    signalosUse: "Experts uses implied upside as one input when ranking analyst-backed ideas.",
  },
  {
    term: "Research Firm",
    category: "Experts Terms",
    definition: "The bank, brokerage, or research organization that publishes an analyst rating or target.",
    example: "Raymond James, KeyBanc, and UBS are firms shown in analyst history.",
    signalosUse: "Experts identifies the publishing firm because rating language and scales can differ between firms.",
  },
  {
    term: "News",
    category: "SigiOS Tools",
