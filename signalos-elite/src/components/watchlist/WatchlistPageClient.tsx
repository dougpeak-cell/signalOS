...
import { readWatchlist, readWatchlistEntries } from "@/lib/watchlist/localWatchlist";
...
export default function WatchlistPageClient({
  ...
  function removeFromWatchlist(tickerToRemove: string) {
    ...
    setWatchlist((prev) => {
      ...
      try {
        window.localStorage.setItem("signalos.watchlist.v1", JSON.stringify(next));
      } catch {}
