    ...
    <>
      <div className="flex items-center gap-2">
        <button
          ...
          className="inline-flex items-center justify-center rounded-xl bg-orange-500/90 px-4 py-2 text-sm font-semibold text-black transition hover:bg-orange-400"
        >
          + Add Stock
        </button>
