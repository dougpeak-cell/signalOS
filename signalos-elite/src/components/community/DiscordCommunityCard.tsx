...
export default function DiscordCommunityCard() {
  return (
    <section className="rounded-3xl border border-cyan-500/20 bg-slate-950/90 p-6 shadow-[0_18px_40px_rgba(0,0,0,0.3)]">
      ...
      <DiscordInviteButton className="mt-5 inline-flex items-center rounded-full border border-cyan-400/30 bg-cyan-400/12 px-5 py-2.5 text-sm font-medium text-cyan-100 transition hover:border-cyan-300/40 hover:bg-cyan-400/18" />
    </section>
  );
}