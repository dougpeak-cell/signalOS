  ...
  return (
    <div className="space-y-6 min-w-0">
      <div className="sig-panel rounded-3xl p-5">
        ...
        <div
          className="mt-4 sig-card-soft rounded-2xl p-4"
          onClick={() => setActiveTicker(topSetup.ticker)}
        >
          ...
          <div className="mt-3 flex items-start justify-between gap-3">
            <div className="min-w-0">
              <TickerHover ticker={topSetup.ticker}>
                <div className="inline-block cursor-help text-2xl font-bold tracking-tight text-white">
                  {topSetup.ticker}
                </div>
              </TickerHover>
          ...
          <div className="mt-4">
            <OpenChartButton href={topSetup.href} label="Open Chart" ticker={topSetup.ticker} />
          </div>
        </div>
      </div>
              ...
              <div className="flex items-start justify-between gap-3">
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    <TickerHover ticker={signal.ticker}>
                      <div className="cursor-help text-sm font-semibold tracking-[0.08em] text-white">
                        {signal.ticker}
                      </div>
                    </TickerHover>
                    {index === 0 ? (
